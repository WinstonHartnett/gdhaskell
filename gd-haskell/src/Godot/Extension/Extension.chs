{- This file was generated by `gd-extension-gen`. -}
...
instance From GdnativeVariantType CInt where
  from = fromIntegral . fromEnum
instance From CInt GdnativeVariantType where
  from = toEnum . fromIntegral
{#enum GDNativeVariantOperator as GdnativeVariantOperator {underscoreToCase}
  deriving (Show, Eq, Ord, Bounded) #}
instance From GdnativeVariantOperator CInt where
  from = fromIntegral . fromEnum
instance From CInt GdnativeVariantOperator where
  from = toEnum . fromIntegral
...
{#enum GDNativeCallErrorType as GdnativeCallErrorType {underscoreToCase}
  deriving (Show, Eq, Ord, Bounded) #}
instance From GdnativeCallErrorType CInt where
  from = fromIntegral . fromEnum
instance From CInt GdnativeCallErrorType where
  from = toEnum . fromIntegral
...
{#enum GDNativeExtensionClassMethodFlags as GdnativeExtensionClassMethodFlags {underscoreToCase}
  deriving (Show, Eq, Ord, Bounded) #}
instance From GdnativeExtensionClassMethodFlags CInt where
  from = fromIntegral . fromEnum
instance From CInt GdnativeExtensionClassMethodFlags where
  from = toEnum . fromIntegral
{#enum GDNativeExtensionClassMethodArgumentMetadata as GdnativeExtensionClassMethodArgumentMetadata {underscoreToCase}
  deriving (Show, Eq, Ord, Bounded) #}
instance From GdnativeExtensionClassMethodArgumentMetadata CInt where
  from = fromIntegral . fromEnum
instance From CInt GdnativeExtensionClassMethodArgumentMetadata where
  from = toEnum . fromIntegral
...
instance From GdnativeInitializationLevel CInt where
  from = fromIntegral . fromEnum
instance From CInt GdnativeInitializationLevel where
  from = toEnum . fromIntegral
